...
const DOORWAY = {
  ...
  scenes: [{ place: "the lamp room", question: "Does Aster admit the signal never fired?", pov: "ASTER", length: 700, roster: [] as string[], reach: {} as Record<string, string[]>, presence: {} as Record<string, string>, constraint: {} as Record<string, string[]>, staging: [] as string[] }],
