 ...
 * writer, judge, clarify, catalog-assist). The two invariants hold for every file under prompts/,
 * not just this one: each imports NOTHING from the engine -- every function takes plain strings --
 * and every model-facing string is composed here or under prompts/, nowhere else.
 *
