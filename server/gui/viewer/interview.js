import { esc, reasonOr, slugify, tid, postJson } from "./util.js";
import { APP, draft, FACET_LABELS } from "./state.js";
import { go } from "./nav.js";
import { modal, button, hint, warnLine, thinking, modelSelect, storyNote } from "./ui.js";
...
// ── interview posting ──
// postScaffold lives here (not interview-page.js): the revert helpers above post through it,
// so the page imports it rather than the other way round.
...
// The render surface interview-page.js builds on: every builder the page assembles or wires.
export {
