...
export function sceneReach(sd: SceneDef, def: CharacterDef, catalogs?: Catalogs): Skill[] {
...
export interface SceneRun {
  ...
  io?: SceneIo;
  /** The catalogs (bible, generals, origins) the scene's reach resolves against. Defaults to the
   *  in-code catalogs, so a hand-built SceneRun needs none; runChapter passes the ones the story
   *  was loaded with. */
  catalogs?: Catalogs;
}
